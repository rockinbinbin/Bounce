...
- (void)setUpUserInterface
{
    ...
    self.bottomMenuHairlineColor = BounceRed;
    self.selectionIndicatorColor = BounceRed;
    self.selectedMenuItemLabelColor = BounceRed;
    self.unselectedMenuItemLabelColor = [UIColor blackColor];
    self.menuItemSeparatorColor = BounceRed;
    self.menuItemFont = [UIFont fontWithName:@"AvenirNext-Medium" size:14];
}
