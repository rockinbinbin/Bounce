...
#define LEAVING_GROUP_NOTIFICATION_PREFIX @"0"
#define HOMEPOINT_NOTIFICATION_PREFIX @"1"
#define PENDING_USER_NOTIFICATION_PREFIX @"2"
#define APPROVED_NOTIFICATION_PREFIX @"3"
